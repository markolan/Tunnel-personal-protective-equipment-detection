...
from utils.torch_utils import EarlyStopping, ModelEMA, de_parallel, is_parallel, select_device, \
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'configs/yolov5/yolov5s6.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/V001.yaml', help='dataset.yaml path')
